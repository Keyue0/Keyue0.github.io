    ...
    el.innerHTML = `
      <div class="home-hero">
        ...
        <div style="margin-top:14px;display:flex;gap:8px;flex-wrap:wrap">
          <a class="btn blue" href="#/review">查看冰川复盘</a>
          <a class="btn" href="#/capital-flow">查看资金流向</a>
        </div>
      </div>
      ...
      <div class="home-cards">
        <a class="home-card" href="#/review">
          ...
          ${latest ? `
            <div style="margin-top:12px;border-top:1px solid #2d333b;padding-top:10px">
              <div style="font-size:15px;font-weight:700">最近：${App.esc(latest.date)}</div>
              <div style="font-size:12.5px;color:#8b949e;margin-top:4px">${App.esc(latest.summary || '')}</div>
